...
hi 	Comment		ctermfg=6 guifg=cyan
hi 	Conditional	ctermfg=2 cterm=bold term=bold guifg=lightgreen
...
hi 	Operator	ctermfg=3 cterm=bold term=bold guifg=lightyellow
hi 	Repeat 		ctermfg=2 guifg=green
